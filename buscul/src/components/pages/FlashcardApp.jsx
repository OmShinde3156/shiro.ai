  ...
  return (
    <div className="flashcard-app">
      <div className="app-container max-w-4xl mx-auto pt-8">
        ...
        <div className={`ease-controls flex gap-3 transition-all duration-500 ${isFlipped ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4 pointer-events-none'}`}>
        ...
        {/* Navigation Controls - Only show when NOT flipped or in non-review mode */}
        {!isFlipped && (
