...
class QuizService:
    ...
    async def generate_quiz_from_document(self, document_id: int, num_questions: int, difficulty: str, db: Session, user_id: Optional[int] = None):
        """Fetch pre-generated quiz questions or generate with QualityGate grounding validation (AI-02)"""
